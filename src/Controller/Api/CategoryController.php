...
class CategoryController
{
     ...
     * @Rest\QueryParam(name="count", requirements="\d+", default="10", description="Number of categories per page")
     * @Rest\QueryParam(name="enabled", requirements="0|1", nullable=true, strict=true, description="Enables or disables the categories filter")
    ...
    {
        $category = null !== $id ? $this->getCategory($id) : null;
