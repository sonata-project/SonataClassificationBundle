...
class ContextController
{
     ...
     *
     * @Operation(
     *     tags={"/api/classification/contexts"},
     ...
     *         name="count",
     *         in="query",
     *         description="Number of contexts per page",
     *         required=false,
     *         type="string"
     *     ),
     *     @SWG\Parameter(
     *         name="enabled",
     *         in="query",
     *         description="Enables or disables the contexts filter",
     *         required=false,
     *         type="string"
     *     ),
     *     @SWG\Response(
     ...
     * @Rest\QueryParam(name="count", requirements="\d+", default="10", description="Number of contexts per page")
     * @Rest\QueryParam(name="enabled", requirements="0|1", nullable=true, strict=true, description="Enables or disables the contexts filter")
     *
    ...
    /**
     * Retrieves context for the given id or throws an exception if it doesn't exist.
     *
     * @param string $id Context identifier
     *
     * @throws NotFoundHttpException
    ...
    protected function handleWriteContext($request, $id = null)
    {
        ...
        $form = $this->formFactory->createNamed(null, ApiContextType::class, $context, [
