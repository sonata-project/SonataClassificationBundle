...
class TagController
{
     ...
     * @Rest\QueryParam(name="count", requirements="\d+", default="10", description="Number of tags per page")
     * @Rest\QueryParam(name="enabled", requirements="0|1", nullable=true, strict=true, description="Enables or disables the tags filter")
     *
    ...
    /**
     * Writes a tag. This method is used by both POST and PUT action methods.
     *
     * @param Request     $request Symfony request
    ...
    protected function handleWriteTag($request, $id = null)
    {
        ...
        $form = $this->formFactory->createNamed(null, ApiTagType::class, $tag, [
